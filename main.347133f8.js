...
exports.venueRecommendationsForUsers = venueRecommendationsForUsers;
function venueHasFoodForUser(venue, user) {
    return !venue.food.every(function (food) {
        return user.wont_eat.includes(food);
    });
}

function venueHasDrinkForUser(venue, user) {
    return venue.drinks.some(function (drink) {
        return user.drinks.includes(drink);
    });
}

function venueRecommendationsForUsers(users, venues) {
    var recommend = venues.filter(function (venue) {
        return users.every(function (user) {
            return venueHasFoodForUser(venue, user) && venueHasDrinkForUser(venue, user);
        });
    });
    var avoid = venues.filter(function (venue) {
        return !recommend.includes(venue);
    }).map(function (venue) {
        return {
            name: venue.name,
            reasons: users.reduce(function (prev, user) {
                return !venueHasDrinkForUser(venue, user) ? prev.concat("There is nothing to drink for " + user.name) : !venueHasFoodForUser(venue, user) ? prev.concat("There is nothing to eat for " + user.name) : prev;
            }, [])
        };
    });
    return {
...
exports.cleanVenues = cleanVenues;
...
function cleanVenues(venues) {
    return venues.map(function (venue) {
        return _extends({}, venue, {
...
exports.default = {
  props: {
    ...
    avoid: {
      ...
      var $37d509 = exports.default || module.exports;
      if (typeof $37d509 === 'function') {
        $37d509 = $37d509.options;
      }
    
        /* template */
        Object.assign($37d509, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h2',[_vm._v("Places to go")]),_vm._v(" "),_c('ul',_vm._l((_vm.recommend),function(venue){return _c('li',{key:venue.name},[_vm._v("\n            "+_vm._s(venue.name)+"\n        ")])})),_vm._v(" "),_c('h2',[_vm._v("Places to avoid")]),_vm._v(" "),_c('ul',_vm._l((_vm.avoid),function(venue){return _c('li',{key:venue.name},[_vm._v("\n            "+_vm._s(venue.name)+"\n            "),_c('ul',_vm._l((venue.reasons),function(reason,idx){return _c('li',{key:idx},[_vm._v("\n                    "+_vm._s(reason)+"\n                ")])}))])}))])}
var staticRenderFns = []
...
var _venueRecommendationsForUsers = require("./venue-recommendations-for-users.js");

var _cleanData = require("./clean-data.js");

var _users = require("../data/users.json");

var _users2 = _interopRequireDefault(_users);

var _venues = require("../data/venues.json");

var _venues2 = _interopRequireDefault(_venues);

var _PlacesToGo = require("./PlacesToGo");

var _PlacesToGo2 = _interopRequireDefault(_PlacesToGo);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = {
  components: {
    PlacesToGo: _PlacesToGo2.default
  },
  data: function data() {
    return (0, _venueRecommendationsForUsers.venueRecommendationsForUsers)((0, _cleanData.cleanUsers)(_users2.default), (0, _cleanData.cleanVenues)(_venues2.default));
  }
}; //
//
//
...
//
//
      var $20e120 = exports.default || module.exports;
      if (typeof $20e120 === 'function') {
        $20e120 = $20e120.options;
      }
    
        /* template */
        Object.assign($20e120, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h1',[_vm._v("Where should we go?")]),_vm._v(" "),_c('PlacesToGo',{attrs:{"recommend":_vm.recommend,"avoid":_vm.avoid}})],1)}
var staticRenderFns = []
...
},{"./venue-recommendations-for-users.js":13,"./clean-data.js":14,"../data/users.json":15,"../data/venues.json":16,"./PlacesToGo":17}],4:[function(require,module,exports) {
'use strict';
...
},{"vue":8,"./App.vue":6}]},{},[4], null)
//# sourceMappingURL=/where-should-we-go/main.9fa9df84.map